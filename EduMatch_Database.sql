...
CREATE TABLE ClassStudents (
                               ...
                               UNIQUE (ClassID, StudentID) -- Đảm bảo mỗi học viên chỉ học một lần trong lớp đó
);
...
CREATE TABLE ClassRegistrations (
                                    ...
                                    FOREIGN KEY (ClassID) REFERENCES Classes(ID) ON DELETE NO ACTION,
                                    UNIQUE (StudentID, ClassID) -- Đảm bảo mỗi học viên chỉ đăng ký một lần vào lớp đó
);